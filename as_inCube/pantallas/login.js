...
export default function Login({ navigation }) {
    ...
    /**
     * We make a query to the api to consult the username and password that are in the Database 
     * and we compare it with the content of the textinput
    ...
    return (
        <View style={styles.layout}>
            ...
            <View>
                ...
                <Text style={styles.title}>InCube</Text>
                <View style={{ height: 10 }} />
            </View>
            <TextInput
                style={styles.width}
                onChangeText={(newText) => setUser(newText)}
                left={<TextInput.Icon icon="account" iconColor="orange" />}
                maxLength={20}
                value={user}
            ...
            <TextInput
                ...
                left={<TextInput.Icon icon="lock" iconColor="orange" />}
                right={
                    <TextInput.Icon
                        icon={eye}
